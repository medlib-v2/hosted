...
mysql --user="root" --password="secret" -e "CREATE USER 'hosted'@'0.0.0.0' IDENTIFIED BY 'secret';"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'hosted'@'0.0.0.0' IDENTIFIED BY 'secret' WITH GRANT OPTION;"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'hosted'@'%' IDENTIFIED BY 'secret' WITH GRANT OPTION;"
